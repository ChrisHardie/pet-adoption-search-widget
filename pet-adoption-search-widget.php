...
class Pet_Adoption_Search_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array(
				'description' => __( 'A widget to display a pet adoption search form for Adopt-a-Pet.com.', 'pet_adoption_search_widget_domain' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="pet_adoption_search_widget_main intrinsic-ignore" style="text-align: center;">
			<iframe class="" width="150" height="240" frameborder="0" marginwidth="0" marginheight="0" scrolling="0"
			        src="https://searchtools.adoptapet.com/public/searchtools/display/150x240"></iframe>';
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_credit_p' ) ); ?>">
				<?php esc_html_e( 'Include credit link to Adopt-a-Pet.com?' ); ?></label>
		</p>
	<?php
